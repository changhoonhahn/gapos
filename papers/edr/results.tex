...
\begin{figure}
\begin{center}
    \includegraphics[width=0.6\textwidth]{figs/psmf_bgs_bright_comp.pdf} 
    \caption{
        The probabilistic SMF of $0.01 < z < 0.05$ BGS galaxies in the
        One-Percent Survey. 
    }\label{fig:psmf}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
    \includegraphics[width=0.6\textwidth]{figs/psmf_bgs_bright_zevo.pdf} 
    \caption{
        The probabilistic SMF of $0.01 < z < 0.05$ BGS galaxies in the
        One-Percent Survey. 
    }\label{fig:psmfz}
...
We present the probabilistic SMF of $0.01 < z < 0.05$ BGS galaxies in the
...
conservative uncertainty estimates~\citep{norberg2009}. 

We also include SMF measurements from previous spectroscopic surveys
SDSS~\citep{moustakas2013} (black circle) and GAMA~\citep{driver2022} (black
triangle).
Since \cite{moustakas2013} and \cite{driver2022} derive $M_*$ using different
SED models we include a $M_*$ offset based on overlapping galaxies. 
