...
vmaxes = Planck13.comoving_volume(bgs['provabgs_z_max'].data).value * Planck13.h**3 * f_area # (Mpc/h)^3 
...
torch.save(best_flows[ibest], os.path.join(dat_dir, 'psmf.gmm.%s.z%.2f_%.2f.best.pt' % (targ, zmin, zmax)))
